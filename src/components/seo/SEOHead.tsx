...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  return (
    <Helmet>
      ...
      <meta name="author" content="Renew Strength and Wellness" />
      ...
      <meta property="og:site_name" content="Renew Strength and Wellness" />
      ...
      <meta name="twitter:site" content="@renewstrength" />
